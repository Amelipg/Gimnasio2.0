...
@p_nutricional.get('/p_nutricionales/', response_model=List[schemas.p_nutricionales.p_nutricional], tags=['Preguntas'])
...
@p_nutricional.get("/p_nutricionales/{id}", response_model=schemas.p_nutricionales.p_nutricional, tags=["Preguntas"])
